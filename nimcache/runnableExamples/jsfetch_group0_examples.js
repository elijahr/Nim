...
var NTI33555876 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
NTI1006633071.base = NTI33555172;
...
NTI1006633102.base = NTI33555172;
...
NTI1006633029.base = NTI33555172;
...
var NNI33555876 = {kind: 2, len: 3, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554435, name: "Field1", sons: null}, 
{kind: 1, offset: "Field2", len: 0, typ: NTI33554450, name: "Field2", sons: null}]};
NTI33555876.node = NNI33555876;
...
var NNI33555182 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI33555182.node = NNI33555182;
NTI33555182.base = NTI33555172;
NTI1023410180.base = NTI33555182;
...
function nimCopy(dest_p0, src_p1, ti_p2) {
  var result_33557386 = null;
    ...
    case 23:
    case 5:
      if (!(isFatPointer__system_u2934(ti_p2))) {
      result_33557386 = src_p1;
      }
      else {
        result_33557386 = [src_p1[0], src_p1[1]];
      }
    ...
    case 19:
      ...
      result_33557386 = dest_p0;
    
      break;
    case 18:
    case 17:
      if (!((ti_p2.base == null))) {
      result_33557386 = nimCopy(dest_p0, src_p1, ti_p2.base);
      }
      else {
      if ((ti_p2.kind == 17)) {
      result_33557386 = (dest_p0 === null || dest_p0 === undefined) ? {m_type: ti_p2} : dest_p0;
      }
      else {
        result_33557386 = (dest_p0 === null || dest_p0 === undefined) ? {} : dest_p0;
      }
      }
      nimCopyAux(result_33557386, src_p1, ti_p2.node);
      break;
    case 4:
    case 16:
        ...
        if (src_p1 === null) {
          ...
          for (var i = 0; i < src_p1.length; ++i) {
            result_33557386[i] = nimCopy(result_33557386[i], src_p1[i], ti_p2.base);
          }
        }
      }
    ...
    case 28:
            if (src_p1 !== null) {
        result_33557386 = src_p1.slice(0);
      }
...
function isObj(obj_p0, subclass_p1) {
  var result_33557499 = false;

  BeforeRet: {
    var x_33557500 = obj_p0;
    if ((x_33557500 == subclass_p1)) {
    result_33557499 = true;
    break BeforeRet;
    }
    
    Label1: {
        Label2: while (true) {
        if (!!((x_33557500 == subclass_p1))) break Label2;
          if ((x_33557500 == null)) {
          result_33557499 = false;
          break BeforeRet;
          }
          
          x_33557500 = x_33557500.base;
        }
    };
    result_33557499 = true;
    break BeforeRet;
  ...
  return result_33557499;

}

function toJSStr(s_p0) {
  var result_33556963 = null;

    var res_33557029 = newSeq__system_u2572((s_p0).length);
    var i_33557030 = 0;
    var j_33557031 = 0;
    Label1: {
        Label2: while (true) {
        if (!(i_33557030 < (s_p0).length)) break Label2;
          var c_33557032 = s_p0[i_33557030];
          if ((c_33557032 < 128)) {
          res_33557029[j_33557031] = String.fromCharCode(c_33557032);
          i_33557030 += 1;
          }
          else {
            var helper_33557058 = newSeq__system_u2572(0);
            Label3: {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33557059 = c_33557032.toString(16);
                  if ((((code_33557059) == null ? 0 : (code_33557059).length) == 1)) {
                  helper_33557058.push("%0");;
                  }
                  else {
                  helper_33557058.push("%");;
                  }
                  
                  helper_33557058.push(code_33557059);;
                  i_33557030 += 1;
                  if ((((s_p0).length <= i_33557030) || (s_p0[i_33557030] < 128))) {
                  break Label3;
                  }
                  
                  c_33557032 = s_p0[i_33557030];
                }
            };
++excHandler;
            try {
            res_33557029[j_33557031] = decodeURIComponent(helper_33557058.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            raiseDefect();
            res_33557029[j_33557031] = helper_33557058.join("");
    ...
    if (res_33557029.length < j_33557031) { for (var i = res_33557029.length ; i < j_33557031 ; ++i) res_33557029.push(null); }
               else { res_33557029.length = j_33557031; };
    result_33556963 = res_33557029.join("");

  return result_33556963;
...
function raiseException(e_p0, ename_p1) {
    ...
    e_p0.trace = nimCopy(null, rawWriteStackTrace__system_u2224(), NTI33554449);
    throw e_p0;
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557695 = false;
    F.line = 31;
    var item_33557696 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557695 = item_33557696 !== undefined;
    if (tmp_33557695) {
    F.line = 34;
    result_33557694 = nimCopy(null, makeNimstrLit(item_33557696.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557694 = nimCopy(null, (HEX24__systemZdollars_u14(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557694;
...
function isFatPointer__system_u2934(ti_p0) {
  var result_33557368 = false;

  BeforeRet: {
    result_33557368 = !((ConstSet1[ti_p0.base.kind] != undefined));
    break BeforeRet;
  };

  return result_33557368;
...
function add__system_u1985(x_p0, x_p0_Idx, y_p1) {
...
function auxWriteStackTrace__system_u2129(f_p0) {
  var result_33556563 = [[]];

    var it_33556568 = f_p0;
    var i_33556569 = 0;
    var total_33556570 = 0;
    var tempFrames_33556571 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555876);
    Label1: {
        Label2: while (true) {
        if (!(!((it_33556568 == null)) && (i_33556569 <= 63))) break Label2;
          tempFrames_33556571[i_33556569].Field0 = it_33556568.procname;
          tempFrames_33556571[i_33556569].Field1 = it_33556568.line;
          tempFrames_33556571[i_33556569].Field2 = it_33556568.filename;
          i_33556569 += 1;
          total_33556570 += 1;
          it_33556568 = it_33556568.prev;
        }
    };
    Label3: {
        Label4: while (true) {
        if (!!((it_33556568 == null))) break Label4;
          total_33556570 += 1;
          it_33556568 = it_33556568.prev;
        }
    };
    result_33556563[0] = nimCopy(null, [], NTI33554449);
    if (!((total_33556570 == i_33556569))) {
    nimAddStrStr(result_33556563[0], [40]);;
    nimAddStrStr(result_33556563[0], HEX24__systemZdollars_u14((total_33556570 - i_33556569)));;
    nimAddStrStr(result_33556563[0], [32,99,97,108,108,115,32,111,109,105,116,116,101,100,41,32,46,46,46,10]);;
    }
    
    Label5: {
      var j_33556604 = 0;
      var colontmp__687866306 = 0;
      colontmp__687866306 = (i_33556569 - 1);
      var res_687866308 = colontmp__687866306;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_687866308)) break Label7;
            j_33556604 = res_687866308;
            nimAddStrStr(result_33556563[0], cstrToNimstr(tempFrames_33556571[j_33556604].Field2));;
            if ((0 < tempFrames_33556571[j_33556604].Field1)) {
            nimAddStrStr(result_33556563[0], [40]);;
            addInt__stdZprivateZdigitsutils_u241(result_33556563, 0, tempFrames_33556571[j_33556604].Field1);
            if (false) {
            nimAddStrStr(result_33556563[0], [44,32]);;
            addInt__stdZprivateZdigitsutils_u241(result_33556563, 0, 0);
            }
            
            nimAddStrStr(result_33556563[0], [41]);;
            }
            
            nimAddStrStr(result_33556563[0], [32,97,116,32]);;
            add__system_u1985(result_33556563, 0, tempFrames_33556571[j_33556604].Field0);
            nimAddStrStr(result_33556563[0], [10]);;
            res_687866308 -= 1;
          }
      };
    };

  return result_33556563[0];

}

function rawWriteStackTrace__system_u2224() {
  var result_33556657 = [];

    if (!((framePtr == null))) {
    result_33556657 = nimCopy(null, ([84,114,97,99,101,98,97,99,107,32,40,109,111,115,116,32,114,101,99,101,110,116,32,99,97,108,108,32,108,97,115,116,41,10]).concat(auxWriteStackTrace__system_u2129(framePtr)), NTI33554449);
    }
    else {
      result_33556657 = nimCopy(null, [78,111,32,115,116,97,99,107,32,116,114,97,99,101,98,97,99,107,32,97,118,97,105,108,97,98,108,101,10], NTI33554449);
    }
    

  return result_33556657;

}

function newSeq__system_u2572(len_p0) {
  var result_33557008 = [];
  ...
  framePtr = F;
    ...
    result_33557008 = new Array(len_p0); for (var i = 0 ; i < len_p0 ; ++i) { result_33557008[i] = null; }  framePtr = F.prev;

  return result_33557008;

}

function isNimException__system_u2060() {
...
function getCurrentException() {
  var result_33556495 = null;

    if (isNimException__system_u2060()) {
    result_33556495 = lastJSError;
    }
    

  return result_33556495;

}

function raiseDefect() {
    if (isNimException__system_u2060()) {
    var e_33556708 = getCurrentException();
    if (isObj(e_33556708.m_type, NTI33555177)) {
    if ((excHandler == 0)) {
    unhandledException(e_33556708);
    }
    
    e_33556708.trace = nimCopy(null, rawWriteStackTrace__system_u2224(), NTI33554449);
    throw e_33556708;
    }
...
function unhandledException(e_p0) {
    ...
    nimAddStrStr(buf_33556702[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110,58,32]);;
    nimAddStrStr(buf_33556702[0], e_p0.message);;
    }
    else {
    nimAddStrStr(buf_33556702[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110]);;
    }
    
    nimAddStrStr(buf_33556702[0], [32,91]);;
    add__system_u1985(buf_33556702, 0, e_p0.name);
    nimAddStrStr(buf_33556702[0], [93,10]);;
    nimAddStrStr(buf_33556702[0], rawWriteStackTrace__system_u2224());;
    var cbuf_33556703 = toJSStr(buf_33556702[0]);
    framePtr = null;
      if (typeof(Error) !== "undefined") {
    throw new Error(cbuf_33556703);
  }
  else {
    throw cbuf_33556703;
  }
